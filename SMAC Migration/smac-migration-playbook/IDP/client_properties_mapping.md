# Table Mapping: ClientProperties → client_properties

## Overview
- **Legacy Database**: synergy_identity_shore_prod
- **Legacy Schema**: public
- **Legacy Table**: ClientProperties (case-sensitive)
- **New Database**: smac_idp_dev
- **New Schema**: public
- **New Table**: client_properties (lowercase)
...
- **clients** - must be migrated before client_properties
