...
- Migrates cba_wage_amount_ot (Overtime) from synergy_master.wages schema. Depends on cba_wage_charts. Preserves identifier/uuid when available.
...
|---|---------------|-------------|------------|----------|----------------|-------|
| 1 | id | - | id | - | migration.resolve_target_id() | migration.resolve_target_id( 'synergy_master'::VARCHAR(100), 'wages'::VARCHAR(100), 'cba_wage_amount_ot'::VARCHAR(100), legacy_data.id::text, current_database()::text::VARCHAR(1... |
| 2 | derived | - | cba_wage_scale_id | - | cws_mapping.new_id as cba_wage_scale_id | cws_mapping.new_id |
| 3 | ot_rate | - | ot_rate | - | legacy_data.ot_rate as ot_rate | legacy_data.ot_rate |
| 4 | ot_hours | - | ot_hours | - | legacy_data.ot_hours as ot_hours | legacy_data.ot_hours |
