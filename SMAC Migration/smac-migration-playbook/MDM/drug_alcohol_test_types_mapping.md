...
|---|---------------|-------------|------------|----------|----------------|-------|
| 1 | id | - | id | - | migration.resolve_target_id() | migration.resolve_target_id( 'synergy_seafarer'::VARCHAR(100), 'public'::VARCHAR(100), 'drug_alcohol_test_types'::VARCHAR(100), legacy_data.id::text, current_database()::text::V... |
| 2 | derived | - | code | - | UPPER(REPLACE(TRIM(name), ' ', '_')) as code | UPPER(REPLACE(TRIM(name), ' ', '_')) |
