...
|---|---------------|-------------|------------|----------|----------------|-------|
| 1 | id | - | id | - | migration.resolve_target_id() | migration.resolve_target_id( 'synergy_master'::VARCHAR(100), 'public'::VARCHAR(100), 'non_synergy_group_companies'::VARCHAR(100), legacy_data.id::text, current_database()::text:... |
...
| 12 | created_by, updated_by | - | audit_info | - | migration.build_audit_info() | migration.build_audit_info( legacy_data.created_by::varchar, NULL::varchar, legacy_data.updated_by::varchar, NULL::varchar, NULL::varchar, NULL::timestamp, NULL::varchar, NULL::... |
