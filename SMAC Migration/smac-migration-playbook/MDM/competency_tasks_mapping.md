...
|---|---------------|-------------|------------|----------|----------------|-------|
| 1 | id, taskid | - | id | - | migration.resolve_target_id() | migration.resolve_target_id( 'efr'::VARCHAR(100), 'public'::VARCHAR(100), 'competency_tasks'::VARCHAR(100), legacy_data.id::text, current_database()::text::VARCHAR(100), 'crewin... |
| 2 | name | - | code | - | generate_meaningful_code() | generate_meaningful_code(legacy_data.name, NULL) |
| 3 | derived | - | competency_type_id | - | ct_mapping.new_id as competency_type_id | ct_mapping.new_id |
...
| 7 | derived | - | assessment_criteria | - | TRIM(assessment_criteria) as assessment_criteria | TRIM(assessment_criteria) |
